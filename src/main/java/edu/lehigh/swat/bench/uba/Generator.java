...
public class Generator {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Usage: Generator\n" +
                         ...
                         "\t-dir <direcotry to store the generated data>");
      System.exit(0);
    }

    new Generator().start(univNum, startIndex, seed, daml, ontology, dir);
  }
  ...
  private void _generate() {
    ...
    try {
      log_ = new PrintStream(new FileOutputStream(dir_ + FileSystems.getDefault().getSeparator() + LOG_FILE));
      writer_.start();
  ...
  private void _generateDept(int univIndex, int index) {
    String fileName = dir_ + FileSystems.getDefault().getSeparator() +
